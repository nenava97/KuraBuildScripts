...
token=$((curl -s --location --request POST 'https://accounts.spotify.com/api/token' --header 'Authorization: Basic NmR..lZjFhMDk4NDAzZmFhYjkyMjY4MDc1YmEzNWM=' --header 'Content-Type: application/x-www-form-urlencoded' --header 'Cookie: sp_ab=%7B%222019_04_premium_menu%22%3A%22control%22%7D; sp_m=us; sp_t=16613598-81d4-4b7e-a0bf-28a39f37f5ce; spot=%7B%22t%22%3A1663020289%2C%22m%22%3A%22us%22%2C%22p%22%3Anull%7D; __Host-device_id=AQAA2NAs9Ox4VBCufXvEuQdtD99g4VESX3lR-7pLvKHXvh-o0HMQliCDLTh-fLw8_Z4uj7W1lUsAuCJ8-ZMaBLTDC_d5mkhpd0g' --data-urlencode 'grant_type=client_credentials') | cut -d '"' -f 4)
